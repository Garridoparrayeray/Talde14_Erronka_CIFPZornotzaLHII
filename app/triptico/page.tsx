...
function PanelArchitecture() {
  return (
    <div className="panel bg-[#F6F4EE]">
      ...
      {/* Tech stack */}
      <div className="mt-5">
        <div className="text-[17px] tracking-[.22em] uppercase text-[#5B628A] font-semibold mb-3">Stack tecnológico</div>
      ...
      {/* MVC */}
      <div className="mt-5">
        <div className="text-[17px] tracking-[.22em] uppercase text-[#5B628A] font-semibold mb-3.5">Patrón · MVC</div>
